            ...
            <div className="flex flex-wrap gap-4 mb-12">
              {Object.entries(project.links).map(([label, href]) => (
                <a 
                  ...
                  className="group relative flex items-center justify-between gap-3 px-5 py-2.5 border border-[var(--text)]/20 bg-[var(--bg)] transition-all duration-75 hover:-translate-x-[2px] hover:-translate-y-[2px] hover:shadow-[2px_2px_0px_var(--text),inset_0_0_0_1px_var(--text)] hover:border-[var(--text)] active:translate-x-0 active:translate-y-0 active:shadow-none no-underline"
                  style={{ fontFamily: "var(--font-geist-mono)" }}
                >
                  <span className="relative text-[11px] font-bold tracking-widest uppercase text-[var(--text)] transition-colors duration-75">
                    {label}
                  </span>
